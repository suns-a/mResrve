        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('events.store') }}">
                ...
                <div class="mt-4">
                    ...
                    <x-jet-input id="end_time" class="block mt-1 w-full" type="text" name="end_time" required autocomplete="current-password" />
                </div>
                </div>
                <div class="md:flex justify-between items-end">
                <div class="mt-4">
                    <x-jet-label for="max_people" value="定員数" />
                    <x-jet-input id="max_people" class="block mt-1 w-full" type="number" name="max_people" required autocomplete="current-password" />
                </div>
